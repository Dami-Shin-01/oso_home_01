  ...
  return NextResponse.json(
    {
      ...
      message: 'This user reservation detail API has been deprecated. Please use the new /api/reservations/lookup endpoint.',
      code: 'API_DEPRECATED',
      deprecated_since: '2024-09-16',
      migration_guide: 'Use /api/reservations/lookup for querying reservations'
    },
    { status: 410 }
  );
}
...
export async function PUT(request: NextRequest) {
  return NextResponse.json(
    {
      error: 'This API endpoint is deprecated',
      message: 'This user reservation update API has been deprecated. Please use the new /api/reservations endpoint.',
      code: 'API_DEPRECATED',
      deprecated_since: '2024-09-16',
...
export async function DELETE(request: NextRequest) {
  return NextResponse.json(
    {
      error: 'This API endpoint is deprecated',
      message: 'This user reservation cancellation API has been deprecated. Please use the new /api/reservations endpoint.',
      code: 'API_DEPRECATED',
      deprecated_since: '2024-09-16',
